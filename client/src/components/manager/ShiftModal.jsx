...
export default function ShiftModal({
    ...
    if (shift) {
      setFormData({
        ...
        startAt: shift.startAt
          ? new Date(shift.startAt).toISOString().slice(0, 16)
          : "",
        endAt: shift.endAt
  ...
  const handleCheckConflicts = async () => {
    ...
    try {
      ...
      setConflicts(
        result.data || { hasConflicts: false, conflicts: [], warnings: [] }
      );
    } catch (error) {
    ...
    <div className='modal-overlay' onClick={onClose}>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className='modal-body'>
          ...
          <div className='form-group'>
            <label>
              {language === "bn" ? "প্রয়োজনীয় ভূমিকা" : "Role Required"} *
            </label>
            <select
              value={formData.roleRequired}
              onChange={(e) =>
                setFormData({ ...formData, roleRequired: e.target.value })
              }
              required
            >
          ...
          <div className='form-group'>
            <label>
              {language === "bn" ? "বিরতি (মিনিট)" : "Break Minutes"}
            </label>
            <input
              type='number'
              min='0'
          ...
          <div className='form-group'>
            ...
            <textarea
              ...
              rows='3'
              placeholder={
                language === "bn" ? "ঐচ্ছিক নোট..." : "Optional notes..."
              }
            />
          </div>
