...
export default function PayrollDetailsModal({
  ...
  return (
    <div className='modal-overlay' onClick={onClose}>
      <div
        className='modal-content payroll-details-modal'
        ...
        <div className='modal-header'>
          <div>
            ...
            <p className='text-secondary'>
              Detailed breakdown of employee payment
            </p>
          </div>
          ...
          <div className='modal-body'>
                  ...
                  <table>
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <td>
                          <strong>
                            {data.totalHoursWorked?.toFixed(2)} hrs
                          </strong>
                        </td>
                      </tr>
                    </tfoot>
            ...
            <div className='info-section'>
              ...
              <div className='calculation-breakdown'>
                <div className='calc-row'>
                  ...
                  <span>৳{data.hourlyRate?.toFixed(2)}/hr</span>
                </div>
                <div className='calc-row'>
                  <span>Hours Worked</span>
                  <span>{data.totalHoursWorked?.toFixed(1)} hrs</span>
                </div>
                <div className='calc-row subtotal'>
                  <span>
                    Gross Pay ({data.hourlyRate?.toFixed(2)} ×{" "}
                    {data.totalHoursWorked?.toFixed(1)})
                  </span>
                ...
                {data.absentDeduction > 0 && (
                  <div className='calc-row deduction'>
                    <span>
                      Absent Deduction ({data.attendanceSummary?.absentDays}{" "}
                      days × ৳10)
                    </span>
                ...
                {data.lateDeduction > 0 && (
                  <div className='calc-row deduction'>
                    <span>
                      Late Deduction ({data.attendanceSummary?.lateDays} days ×
                      ৳5)
                    </span>
                ...
                {data.deductions >
                  data.absentDeduction + data.lateDeduction && (
                  <div className='calc-row deduction'>
            ...
            <div className='info-section'>
              ...
              <div className='payment-status'>
                <div
                  className={`status-indicator status-${data.paymentStatus}`}
                >
                ...
                {data.paymentStatus === "given" && data.paidBy && (
                  <div className='payment-info'>
                    <p>
                      <strong>Paid By:</strong> {data.paidBy.name}
                    </p>
                    <p>
                      <strong>Paid At:</strong> {formatDate(data.paidAt)}
                    </p>
                  </div>
                )}
              </div>
